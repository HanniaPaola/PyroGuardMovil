...
import '../domain/usecases/get_citizen_reports_usecase.dart';
import '../data/datasources/citizen_report_remote_datasource.dart';
import '../data/datasources/comunicado_remote_datasource.dart';
...
class CommunityModule {
  static CommunityProvider buildProvider() {
    ...
    // Repositorio para los comunicados
    final apiClient = ApiClient();
    final comunicadoRemoteDataSource = ComunicadoRemoteDataSource(apiClient: apiClient);
    final comunicadoRepo = ComunicadoRepositoryImpl(remote: comunicadoRemoteDataSource);
    ...
    return CommunityProvider(
      ...
      getComunicados: GetComunicadosUsecase(comunicadoRepo),
    );
  }
